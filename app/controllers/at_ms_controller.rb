class AtMsController < ApplicationController
  ...
  private
    ...
    def atm_params
      params.require(:atm).permit(:id, :long, :lat, :bank, :network, :location, :city, :terminals, :blindness_assistance, :dolars, :street, :street_number, :second_street, :neighborhood, :commune, :code, :zipcode)
    end
end
